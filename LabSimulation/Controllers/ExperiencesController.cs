...
namespace LabSimulation.Controllers
{
    public class ExperiencesController : Controller
    {
        ...
        private List<Comment> GetComments(int? experienceID, int? subjectID, int? educationalYearID, int? educationalLevelID)
        {
            return db.Comments.Where(c => c.ID == experienceID && c.SubjectID == subjectID && c.EducationalYearID == educationalYearID && c.EducationalLevelID == educationalLevelID).ToList();
        }
        ...
        public ActionResult CreateComment([Bind(Include = "CommentID,EducationalLevelID,EducationalYearID,SubjectID,ID,UserName,Comments,CommentDateTime")] Comment comment)
        {
